...
function main() {
  return union(
    difference(
        translate([0,l/2-2,-1],cube({size:[40,8,27],center: true})),
        band()
      ),
      translate([0,w/2+17,0],
      rotate([90,180,0],scale([0.4,0.4,1],translate([-38,-18,0],eye())))
      )
  );
}
...
function eye() { return union(
  // objects: 1
  // object #1: triangles: 1560
  polyhedron({ points: [
    [0.481,43.009,-0.5],
    [0.562,42.65,0.5],
    [0.562,42.65,-0.5],
